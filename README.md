...
가장 빠르고 쉬운 설치 방법입니다. (The fastest and easiest way to install.)

1.  [Releases](https://github.com/hslcrb/CommitSearch_extsn/releases) 페이지에서 **v0.0.0**의 `commitsearch-v0.0.0.zip` 파일을 다운로드합니다.
...
*참고: 현재 도커 이미지는 로컬에서 수동으로 빌드하여 관리됩니다.*
(*Note: Docker images are currently built and managed manually from local.*)
